                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column align-items-center justify-content-center p-4">
                            ...
                            <div class="mt-4 text-center demo">
                                <a href="http://<?= $user['instagram'] ?>" class="fs-xl" style="color:#C13584">
                                    <i class="fab fa-instagram"></i>
                                </a>
                                <a href="http://<?= $user['vk'] ?>" class="fs-xl" style="color:#4680C2">
                                    <i class="fab fa-vk"></i>
                                </a>
                                <a href="http://<?= $user['telegram'] ?>" class="fs-xl" style="color:#0088cc">
