...
//var_dump($_POST);
//echo '</pre>';
if (isNotLoggedIn() && $_SESSION['infoUser']['role'] !== 'admin'){
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="realization_create_user.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" name="email" class="form-control" value="">
                                </div>
