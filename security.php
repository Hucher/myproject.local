...
if ($userData['role'] !== 'admin') {
    ...
    if ($author !== true) {
        $_SESSION['warning'] = 'Можно редактировать только свой профиль';
        setFlashMessage('warning', $_SESSION['warning']);
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="realizationEditAuthData.php?id=<?=$userData['user_id']?>" method="post">
            <div class="row">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="simpleinput" name="password" class="form-control" value="<?=$user['password']?>">
                                </div>
